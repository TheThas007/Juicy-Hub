    ...
    <section className="py-24 reveal-on-scroll" id="shop">
      <div className="max-w-[1200px] mx-auto px-5 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-auto md:grid-rows-2 gap-6 md:h-[600px]">
          {/* Falooda - tall card */}
          <div className="md:col-span-1 md:row-span-2 relative group rounded-3xl overflow-hidden bg-black text-white p-8 flex flex-col justify-end min-h-[400px]">
            <img
          ...
          {/* Masala Tea */}
          <div className="relative group rounded-3xl overflow-hidden bg-[#f0edec] p-8 flex flex-col justify-end min-h-[250px]">
            <img
          ...
          <div className="md:col-span-2 relative group rounded-3xl overflow-hidden bg-[#f0edec] p-8 flex flex-col justify-end min-h-[250px]">
